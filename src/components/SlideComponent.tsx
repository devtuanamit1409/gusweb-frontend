...
const Slide: React.FC<any> = ({ brands }) => {
  ...
  return (
    <div className="laptop:max-w-[1140px] w-full laptop:h-[68px] tablet:max-w-[712px] tablet:max-h-[49px] h-[60px] pt-[20px] mb-[20px] relative flex items-center justify-between ">
      <div

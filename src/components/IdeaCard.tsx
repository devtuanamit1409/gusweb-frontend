  ...
  return (
    <div className="w-full bg-gradient-to-r from-[#00d2ff] to-[#3a7bd5]  items-center flex ">
      <div className="custom-container flex flex-col gap-6 mobile:gap-8 max-w-[1116px] laptop:py-[80px]  py-[66px] px-4   items-center ">
        <div className="laptop:h-[180px] gap-4  flex flex-col  items-center text-center w-full" data-aos="zoom-in">
        ...
        <div className="px-4 tablet:px-0 gap-6 flex flex-wrap laptop:flex-nowrap justify-center max-w-[1116px]" data-aos="fade-up">
          {solution.items &&                

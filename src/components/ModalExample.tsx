        ...
        <div className="mobile:flex-col tablet:flex-row flex gap-6 py-[20px] px-4">
          ...
          <div className=" max-w-[594px] max-h-[493px] mx-auto scrollbar-custom overflow-y-auto pr-6 gap-6 flex flex-col">
            <div>
              ...
              <p>
                G-Verification là một ứng dụng phi tập trung được xây dựng trên
                nền tảng của chuỗi khối Ethereum (sử dụng Solidity làm ngôn ngữ
                mã hóa chính) để cho phép khách hàng cá nhân, công ty và tổ chức
                công xác minh Bản ghi tin cậy của bất kỳ người hoặc đối tượng
                nào trên thế giới bằng cách kết nối với nền tảng G-Data
              </p>
              <p>
                Quy trình Xác minh sẽ yêu cầu Mã thông báo GHT làm &quot gas
                &quot cho các hành động, bao gồm Xác minh, Xác nhận, Danh sách
                đen, Sửa đổi, v.v. trên Bản ghi Tin cậy của một người / một đối
                tượng.
              </p>
              <p>
                Những người dùng tham gia vào quá trình Xác minh Niềm tin sẽ
                nhận được Mã thông báo GHT như phần thưởng cho sự hợp tác của họ
                trong việc xây dựng Mạng lưới GHT.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1">
                Một app trên blockchain BSC, app này sẽ cung cấp một dịch vụ để
                người dùng xác minh ai đó / điều gì đó để xây dựng lòng tin.
                Người dùng kết nối với 3 vai trò của ứng dụng: Người yêu cầu /
                Người xác minh / Người xác minh
              </p>
            </div>
            <div>

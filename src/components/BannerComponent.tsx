...
const BannerComponent: React.FC<any> = ({ intro }) => {
  ...
  return (
    <div className="relative mobile:min-h-[582px] py-[80px] w-full laptop:h-[734px]">
      ...
      <div
        className="absolute inset-0 z-30 bg-opacity-70 flex items-center justify-center mx-auto gap-4 max-w-[1116px]"
        data-aos="zoom-in"
      >
        <div className="text-center text-[#FEFEFE] max-w-4xl mx-auto">

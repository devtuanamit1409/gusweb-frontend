...
const WhyCardComponent = (props: Props) => {
  ...
  return (
    <div
      className={`home-service-item__box laptop:h-[499px] laptop:max-w-[261px] tablet:!max-w-[991px] tablet:h-[256px] p-6 rounded-3xl gap-4 bg-white/25 border-white/25 border-2 backdrop-blur-[10px] relative overflow-hidden flex flex-col items-center ${className}`}
    >

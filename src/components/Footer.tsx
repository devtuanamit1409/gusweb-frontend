          ...
          <div className="w-1/2 px-4 sm:px-6 lg:px-8">
            <div className="flex items-center">
              ...
              <div className="ml-4 ">
                ...
                <p>
                  Số 07, Đường 7C, KĐT An Phú An Khánh, phường An Phú, TP. Thủ
                  Đức
                </p>
              </div>
            </div>
        ...
        <div className="flex flex-row w-full">
          <div className="w-[30%] px-4 sm:px-6 lg:px-8">
            <div className="mb-6 space-y-3">
              ...
              <ul className="space-y-3 ">
                <li>
                  <Link
                    className="hover:text-[#08BED5]"
                    href="/vi/services/mobile-app-development/"
                  >
                    Thiết kế website
                  </Link>
                </li>
                ...
                <li>
                  <Link
                    className="hover:text-[#08BED5]"
                    href="https://amitgroup.vn/vi/services/it-staffing-service/"
                  >
                    Case Studies
                  </Link>
                </li>
                <li>
                  <Link
                    className="hover:text-[#08BED5]"
                    href="/vi/services/asp-solutions/"
                  >
                    Blog
                  </Link>
                </li>
                <li>
                  <Link
                    className="hover:text-[#08BED5]"
                    href="/vi/services/website-development/"
                  >
                    Liên hệ
                  </Link>
                </li>
          ...
          <div className="w-[40%] px-4 sm:px-6 lg:px-8 ">
            <div className="mb-6 space-y-3">
              ...
              <ul className="space-y-3">
                <li>
                  <Link className="hover:text-[#08BED5]" href={"/"}>
                    PanUnited’s go Truck mobile application
                  </Link>
                </li>
                <li>
                  <Link className="hover:text-[#08BED5]" href={""}>
                    HUS BMW Application - north America version
                  </Link>
                </li>
                <li>
                  <Link className="hover:text-[#08BED5]" href={""}>

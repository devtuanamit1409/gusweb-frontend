...
const items = [
  {
    key: "1",
    label: <Link href="/service">Phát triển phần mềm theo yêu cầu</Link>,
  },
  {
    key: "2",
    label: <Link href="/service">Offshore Development Center</Link>,
  },
  {
    key: "3",
    label: <Link href="/service">Giải pháp phần mềm có sẵn</Link>,
  },
  {
    key: "4",
    label: <Link href="/service">Thiết kế UX UI</Link>,
  },
  {
    key: "5",
    label: <Link href="/service">Cung cấp nhân sự Công nghệ thông tin</Link>,
  },
];

...
const App: React.FC = () => {
    ...
    return (
        <>
            <p className='text-[#1FA9EC] font-medium text-[15px] underline mt-2 flex flex-row items-center gap-2 leading-6 w-max h-8' onClick={() => setModal2Open(true)}>
                ...
                <div className='mobile:flex-col tablet:flex-row flex gap-6 py-[20px] px-4'>
                    ...
                    <div className=' max-w-[594px] max-h-[493px] mx-auto scrollbar-custom overflow-y-auto pr-6 gap-6 flex flex-col'>
                        <div>
                            ...
                            <p className='font-bold text-[32px] font-bricolage leading-[38.4px]'>GHT Verification app blockchain</p>
                        ...
                        <div className='flex items-center gap-6'>
                            ...
                            <div className='flex max-h-[40px] gap-2'>
                                <Image src='/images/Audi_logo logo.png' alt='GHT ' width={127} height={40} />
                                <Image src='/images/Audi_logo logo.png' alt='GHT ' width={127} height={40} />
                                <Image src='/images/Audi_logo logo.png' alt='GHT ' width={127} height={40} />
                            </div>
                        </div>
                        <div >
                            ...
                            <div className='flex gap-2 mt-1'>
                                <Image src='/svg/android.svg' alt='java ' width={40} height={40} />
                                <Image src='/svg/android.svg' alt='GHT ' width={40} height={40} />
                                <Image src='/svg/android.svg' alt='next ' width={40} height={40} />
                                <Image src='/svg/android.svg' alt='react ' width={40} height={40} />
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className='mt-1'>Một app trên blockchain BSC, app này sẽ cung cấp một dịch vụ để người dùng xác minh ai đó / điều gì đó để xây dựng lòng tin.  Người dùng kết nối với 3 vai trò của ứng dụng: Người yêu cầu / Người xác minh / Người xác minh</p>
                        </div>
                        <div>
                            <p className='font-semibold text-xl leading-[24px] '>Giải pháp</p>
                            <p className='mt-1'>Phát triển trên nền tảng iOS và Android native (Swift và Kotlin), tích hợp công nghệ blockchain Polygon và ETH</p>
                        </div>

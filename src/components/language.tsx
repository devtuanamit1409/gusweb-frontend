...
import { MenuInfo } from 'rc-menu/lib/interface'; // Nhập khẩu MenuInfo
...
const languageOptions = [
    ...
    {
        key: '4',
        label: 'Tiếng Hàn trung',
        abbreviation: 'ZH'
    }
];

export default function Language() {
    const [selectedLanguage, setSelectedLanguage] = useState(languageOptions[0].abbreviation);

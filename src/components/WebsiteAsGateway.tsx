    ...
    <div className=" flex flex-col items-center">
      ...
      <div className="absolute w-full h-full flex flex-col items-center text-center p-4">
        <div className="laptop:max-w-[736px] w-full gap-4 flex flex-col mt-11">
          <h1 className="tablet:text-[56px] text-[40px] text-white leading-[48px] font-medium tablet:font-semibold tracking-[0.2px] font-bricolage laptop:leading-[67.2px]">
            {webUs.intro.title}
          </h1>
          <div className="text-white text-[16px] font-normal h-full leading-[24px] tracking-[0.5px] ">
            {webUs.intro.description}
          </div>
        </div>
        <div className="flex flex-wrap justify-center gap-4 laptop:gap-6 mt-8 tablet:mt-4 laptop:max-w-[1116px] tablet:max-w-[979px] mobile:max-w-[655px] tablet:mx-auto mx-4">
          {webUs.items &&

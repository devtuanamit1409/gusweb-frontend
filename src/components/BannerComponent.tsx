    ...
    <div className="relative  h-[734px] px-[162px] py-[80px]">
      ...
      <div className="absolute inset-0  bg-opacity-70 flex items-center justify-center">
        <div className=" text-center text-white max-w-4xl mx-auto px-4">
          <h1 className="text-6xl md:text-7xl font-bold mb-4 leading-tight font-bricolage line-clamp-1">
            {intro.title}
          </h1>
          <h2 className="text-2xl md:text-3xl font-bold mb-6 font-bricolage line-clamp-1">
            {intro.subTitle}
          </h2>
          <p className="text-lg md:text-xl max-w-2xl mx-auto font-bricolage line-clamp-2">
            {intro.description}
          </p>
        </div>
      </div>
